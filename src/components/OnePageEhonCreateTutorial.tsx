...
export default function OnePageEhonCreateTutorial() {
  ...
  return (
    <Box bg={cardBg} p={[6, 8]} borderRadius="md" boxShadow="md" mb={8}>
      ...
      <VStack align="stretch" spacing={4}>
        ...
        <FormControl isDisabled>
          <FormLabel fontSize="sm">
            {t("labelGenre", { defaultValue: "ジャンル" })}
          </FormLabel>
        ...
        <FormControl isDisabled>
          <FormLabel fontSize="sm">
            {t("labelMainCharacter", { defaultValue: "主人公の動物" })}
          </FormLabel>
        ...
        <FormControl isDisabled>
          <FormLabel fontSize="sm">
            {t("labelStyleDetail", { defaultValue: "アートスタイル" })}
          </FormLabel>
        ...
        <FormControl isDisabled>
          <FormLabel fontSize="sm">
            {t("searchLabelTargetAge", { defaultValue: "対象年齢" })}
          </FormLabel>
        ...
        <FormControl isDisabled>
          <FormLabel fontSize="sm">
            {t("searchLabelPages", { defaultValue: "ページ数" })}
          </FormLabel>
          <Box position="relative" px={2} py={2}>
            <Slider min={5} max={30} step={1} value={pageCount} colorScheme="teal">
