//src/app/[locale]/ehon/create/page.tsx
...
// 絵本生成時のローディング
import EhonLoadingOverlay from "@/components/EhonUltimateLoading";

// ★ ユーザー保有ポイントを参照する SWR
import { useUserSWR } from "@/hook/useUserSWR";

export default function OnePageEhonCreate() {
  ...
  function validateForm() {
    ...
    if (!styleCategory) newErrors.styleCategory = t("errStyleEmpty");
      ...
      >
        ...
        >
          ...
          <VStack align="stretch" spacing={4}>
            ...
            {/* アートスタイル */}
            <FormControl isInvalid={!!errors.styleCategory || !!errors.styleId}>
              ...
              />
              <FormErrorMessage>
                {errors.styleCategory || errors.styleId}
              </FormErrorMessage>
            </FormControl>
            ...
            <FormControl>
              ...
              <Box position="relative" px={2} py={2}>
                ...
                >
                  ...
                  <SliderThumb boxSize={6} transition="0.2s" _hover={{ boxSize: 8 }}>
